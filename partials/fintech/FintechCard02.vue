<template>
  ...
  >
    ...
    <div class="h-full flex flex-col px-5 py-6">
      <!-- CC container -->
      <div
        class="relative w-full max-w-sm mx-auto bg-slate-800 p-3 rounded-2xl"
      >
        <!-- Credit Card -->
        <div
          class="
      ...
      <div class="grow flex flex-col justify-center mt-3">
        <div class="text-xs text-slate-500 font-semibold uppercase mb-3">
          Details
        </div>
        <div class="space-y-2">
          <div>
            <div class="flex justify-between text-sm mb-2">
              ...
              <div class="text-slate-400 italic">
                $780,00 <span class="text-slate-500">/</span> $1,500.00
              </div>
            </div>
          ...
          <div>
            <div class="flex justify-between text-sm mb-2">
              ...
              <div class="text-slate-400 italic">
                $179,00 <span class="text-slate-500">/</span> $1,000.00
              </div>
            </div>
            <div class="relative w-full h-2 bg-slate-600">
              <div
