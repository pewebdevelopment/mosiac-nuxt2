  ...
  <div>
    ...
    <div class="bg-white shadow-md rounded border border-slate-200 p-5">
        ...
        <div class="flex items-start space-x-3">
          ...
          <div>
            <div class="leading-tight">
              <a class="text-sm font-semibold text-slate-800" href="#0"
                >Dominik Lamakani</a
              >
            </div>
      ...
      <div class="text-sm text-slate-800 space-y-2 mb-5">
        <p>👋</p>
        <p>
          It's more likely that people reading your blog will opt in with their
          email addresses if you give them something highly relevant in return.
          Ditch that too-general lead magnet and create "content upgrades" for
        ...
        <div class="flex items-start space-x-3">
          ...
          <div>
            ...
            <div class="inline-flex items-center">
              <svg
                class="w-3 h-3 shrink-0 fill-yellow-500 mr-1"
      ...
      <div class="mt-5 pt-3 border-t border-slate-200">
            ...
            <div class="flex items-start space-x-3">
              ...
              <div>
                <div class="text-xs text-slate-500">
                  <a class="font-semibold text-slate-800" href="#0"
                    >Sophie Wenner</a
                  >
                  · 44min
                </div>
          ...
          <li class="p-3 bg-slate-50 rounded">
            <div class="flex items-start space-x-3">
              ...
              <div>
                ...
                <div class="text-sm">
                  Depends on the company you're running, but if I had to choose
                  just one book, it'd be The Personal MBA by Josh Kaufman.
                </div>
              </div>
            </div>
          </li>
        ...
        <div class="flex justify-between space-x-2">
          <div class="text-sm text-slate-500">
            <span class="font-medium text-slate-600">2</span> of
            <span class="font-medium text-slate-600">67</span> comments
          </div>
          <button
      ...
      <div class="text-sm text-slate-800 space-y-2 mb-5">
        ...
        <div class="relative flex items-center justify-center !my-4">
          ...
          <button class="absolute group">
            ...
            >
              <circle
                class="fill-white opacity-80 group-hover:opacity-100 transition"
                cx="32"
                cy="32"
                r="32"
              />
