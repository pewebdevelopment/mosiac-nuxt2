      ...
      <div class="flex flex-start space-x-4">
        ...
        <div class="grow">
          ...
          <h2 class="font-semibold text-slate-800 mb-2">
            <router-link to="/community/forum-post"
          ...
          <footer class="flex flex-wrap text-sm">
            <div
              class="
                ...
                last:after:content-['']
                after:text-sm after:text-slate-400 after:px-2
              "
            >
              <a
        ...
        <div class="shrink-0">
          ...
          >
            <svg
              class="inline-flex fill-indigo-500 mt-1.5 mb-1.5"
              width="12"
              height="6"
              xmlns="http://www.w3.org/2000/svg"
            >
    ...
    <article class="bg-white shadow-md rounded border border-slate-200 p-5">
      <div class="flex flex-start space-x-4">
        ...
        <div class="shrink-0">
          ...
          >
            <svg
              class="inline-flex fill-slate-400 mt-1.5 mb-1.5"
              width="12"
              height="6"
              xmlns="http://www.w3.org/2000/svg"
            >
        ...
        <div class="grow">
          ...
          <h2 class="font-semibold text-slate-800 mb-2">
            <router-link to="/community/forum-post"
              ...
              last two years — AMA.</router-link
            >
          </h2>
          <!-- Footer -->
          <footer class="flex flex-wrap text-sm">
        ...
        <div class="grow">
          ...
          <h2 class="font-semibold text-slate-800 mb-2">
            <router-link to="/community/forum-post"
              ...
              now building another side project—AMA</router-link
            >
          </h2>
          <!-- Footer -->
          <footer class="flex flex-wrap text-sm">
        ...
        <div class="grow">
          ...
          <h2 class="font-semibold text-slate-800 mb-2">
            <router-link to="/community/forum-post"
              ...
              and incredible performance!</router-link
            >
          </h2>
          <!-- Footer -->
          <footer class="flex flex-wrap text-sm">
        ...
        <div class="grow">
          ...
          <h2 class="font-semibold text-slate-800 mb-2">
            <router-link to="/community/forum-post"
              ...
              growing your audience 🚀</router-link
            >
          </h2>
          <!-- Footer -->
          <footer class="flex flex-wrap text-sm">
