        ...
        <div>
          ...
          <ul class="mt-3">
            ...
            <SidebarLinkGroup
              v-slot="parentLink"
              :activeCondition="
                $route.fullPath === '/' || $route.fullPath.includes('dashboard')
              "
            >
              <a
                class="
                ...
                <div class="flex items-center justify-between">
                  <div class="flex items-center">
                    <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                      ...
                      $route.fullPath.includes('dashboard')) &&
                      '!text-indigo-500' " d="M12 0C5.383 0 0 5.383 0 12s5.383
            ...
            <SidebarLinkGroup
              v-slot="parentLink"
              :activeCondition="$route.fullPath.includes('utility')"
            >
              <a
                class="
                  block
                ...
                "
                :class="
                  $route.fullPath.includes('utility') && 'hover:text-slate-200'
                "
                href="#0"
                @click.prevent="
                  sidebarExpanded
                  ...
                  <div class="flex items-center">
                    <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                      <circle
                        class="fill-current text-slate-400"
                        :class="
                          $route.fullPath.includes('utility') &&
                          'text-indigo-300'
                        "
                        cx="18.5"
                        cy="5.5"
