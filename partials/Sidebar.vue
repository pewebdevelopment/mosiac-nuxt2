        ...
        <div>
          <h3 class="text-xs uppercase text-slate-500 font-semibold pl-3">
            <span
              class="
                hidden
                lg:block lg:sidebar-expanded:hidden
                2xl:hidden
                text-center
                w-6
                px-3
          ...
          <ul class="mt-3" v-if="currentRoute && currentRoute.fullPath">
            ...
            >
              <a
                ...
                "
              >
                <div id="uparwala" class="flex items-center justify-between">
            ...
            <SidebarLinkGroup v-slot="parentLink">
              <a
                class="
                  ...
                  duration-150
                "
                :class="parentLink.expanded && 'hover:text-slate-200'"
                href="#0"
                @click.prevent="
                  sidebarExpanded
                    ? parentLink.handleClick()
              ...
              <div class="lg:sidebar-expanded:block 2xl:block">
                <ul class="pl-9 mt-1" :class="!parentLink.expanded && 'hidden'">
                  ...
                  <nuxt-link to="/signup" custom v-slot="{ href, navigate }">
                    <li class="mb-1 last:mb-0">
                      <a
                        class="
                          block
...
export default {
  ...
  mounted() {
    ...
    // const currentRoute = router.currentRoute.value; // This is how we use the userouter in Vue 3 and Vue Router 4
  },
