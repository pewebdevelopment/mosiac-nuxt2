          ...
          >
            ...
            <div>
              <div class="mb-6">
                ...
                >
                  <svg
                    class="fill-current text-slate-400 mr-2"
                    width="7"
                    height="12"
                    viewBox="0 0 7 12"
                  >
              ...
              <!-- The Role -->
              <div>
                <h2 class="text-xl leading-snug text-slate-800 font-bold mb-2">
                  The Role
                </h2>
                <div class="space-y-6">
                  <p>
              ...
              <!-- Apply section -->
              <div class="mt-6">
                <p class="font-medium text-slate-800 italic mb-6">
              ...
              <!-- Related Jobs -->
              <div>
                <h2 class="text-xl leading-snug text-slate-800 font-bold mb-6">
                  Related Jobs
                </h2>
