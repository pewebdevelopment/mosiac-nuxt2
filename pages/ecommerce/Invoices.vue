            ...
            <ul class="flex flex-wrap -m-1">
              <li class="m-1">
                <button
                  ...
                  "
                >
                  All <span class="ml-1 text-indigo-200">67</span>
                </button>
              </li>
              <li class="m-1">
                <button
                  ...
                  "
                >
                  Paid <span class="ml-1 text-slate-400">14</span>
                </button>
              </li>
              <li class="m-1">
                <button
                  ...
                  "
                >
                  Due <span class="ml-1 text-slate-400">34</span>
                </button>
              </li>
              <li class="m-1">
                <button
                  ...
                  "
                >
                  Overdue <span class="ml-1 text-slate-400">19</span>
                </button>
              </li>
            </ul>
          </div>
