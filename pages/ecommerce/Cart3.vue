          ...
          >
            <div class="lg:max-w-[640px] lg:mx-auto">
              ...
              <div class="mb-6 lg:mb-0">
                <div class="mb-3">
                  <div
                    class="flex text-sm font-medium text-slate-400 space-x-2"
                  >
                ...
                <!-- Billing Information -->
                <div>
                  <div class="text-slate-800 font-semibold mb-4">
                    Billing Information
                  </div>
                  <form>
                    <div class="space-y-4">
                ...
                <div class="bg-white rounded border border-slate-200 p-4">
                  <div
                    class="
                      text-center
                      md:text-left md:flex md:items-center md:justify-between
                      space-y-2
                  ...
                  >
                    <div class="text-sm">
                      Enjoy a
                      <span class="font-medium text-slate-800">20% OFF</span>
                    ...
                    >
                      ...
                      ></div>
                      <span
                        class="text-sm text-emerald-50 font-medium uppercase"
                        >XMAS22</span
                      >
                    </div>
                  </div>
              ...
              <div class="py-8 px-4 lg:px-8 2xl:px-12">
                <div class="max-w-sm mx-auto lg:max-w-none">
                  ...
                  <div class="space-y-6">
                    <!-- Order Details -->
                    <div>
                      <div class="text-slate-800 font-semibold mb-2">
                        Order Details
                      </div>
                      <!-- Cart items -->
                      <ul>
                      ...
                      <ul>
                        ...
                        >
                          ...
                          <div
                            class="text-sm font-medium text-emerald-600 ml-2"
                          >
                            $205
                          </div>
                        </li>
                      ...
                      <div class="text-sm rounded border border-slate-200 p-3">
                        ...
                        >
                          ...
                          <div class="flex items-center">
                            ...
                            <div>
                              Ending with
                              <span class="text-slate-800">2478</span>
                            </div>
                          </div>
                          <!-- Expiry -->
