                ...
                <article class="pt-6">
                  <div class="xl:flex">
                    ...
                    <div class="grow pb-6 border-b border-slate-200">
                      <header>
                        <div
                          class="flex flex-nowrap items-center space-x-2 mb-6"
                        >
                          <!-- Avatars -->
                      ...
                      <ul class="-my-2">
                        ...
                        <li class="relative py-2">
                          <div class="flex items-center mb-1">
                            ...
                            ></div>
                            <div
                              class="absolute left-0 rounded-full bg-indigo-500"
                              aria-hidden="true"
                            >
                              <svg
                              ...
                              >
                                <path
                                  d="M14.4 8.4L13 7l-4 4-2-2-1.4 1.4L9 13.8z"
                                />
                              </svg>
                            </div>
                    ...
                    <div class="grow pb-6 border-b border-slate-200">
                      ...
                      <ul class="-my-2">
                        ...
                        <li class="relative py-2">
                          <div class="flex items-center mb-1">
                            <div
                              class="absolute left-0 rounded-full bg-white"
                              aria-hidden="true"
                            >
                              <svg
